...
export function FeaturesBanner() {
  ...
  // Duplicado 2x para loop seamless com translateX(-50%)
    ...
    <section className="w-full overflow-hidden bg-background pt-6 pb-4 md:pb-4 border-y border-border flex items-center">
      <div className="animate-marquee">
        {allFeatures.map((item, idx) => (
          <div key={idx} className="flex gap-16 px-8 items-center shrink-0 inline-flex">
            <div className="flex items-start gap-4 w-[310px] whitespace-normal">
