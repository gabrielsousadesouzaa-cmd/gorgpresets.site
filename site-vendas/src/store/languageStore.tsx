...
export const translations = {
  ...
  // Magic Section
  magicTitle: { PT: "A Mágica Acontece", EN: "THE MAGIC HAPPENS", ES: "LA MAGIA SUCEDE", FR: "LA MAGIE OPÈRE" },
  magicSubtitle: { PT: "Arraste para o lado e veja a transformação absurda em apenas 1 clique.", EN: "Slide to see the incredible transformation in 1 click.", ES: "Desliza para ver la increíble transformación en 1 clic.", FR: "Faites glisser pour voir l'incroyable transformation en 1 clic." },
  ...
  test5Text: { PT: "Simplesmente incrível! Os tons são muito naturais e valorizam demais a pele. Meus retratos agora parecem profissionais e recebo elogios todos os dias.", EN: "Simply amazing! The tones are very natural and really enhance the skin. My portraits now look professional and I get compliments every day.", ES: "¡Simplemente increíble! Los tonos son muy naturales y realzan mucho la piel. Mis retratos ahora parecen profesionales y recibo cumplidos todos los días.", FR: "Tout simplement incroyable! Les tons sont très naturels et subliment vraiment la peau. Mes portraits ont maintenant l'air professionnels." },
  test6Text: { PT: "Melhor investimento para quem quer um perfil de luxo no Instagram. Praticidade nota 10, edito tudo em segundos no celular antes de postar.", EN: "Best investment for those who want a luxury profile on Instagram. Practicality is 10/10, I edit everything in seconds on my phone before posting.", ES: "La mejor inversión para quienes quieren um perfil de lujo en Instagram. Practicidad de 10, edito todo en segundos en mi celular antes de publicar.", FR: "Meilleur investissement pour ceux qui veulent un profil de luxe sur Instagram. Praticité 10/10, je retouche tout en quelques secondes." },
  test7Text: { PT: "Eu não sabia nada de edição, mas com esses presets minhas fotos subiram de nível instantaneamente. O guia de instalação é super claro e fácil.", EN: "I didn't know anything about editing, but with these presets my photos leveled up instantly. The installation guide is super clear and easy.", ES: "No sabía nada de edición, pero con estos presets mis fotos subieron de nivel al instante. La guía de instalación es súper clara y fácil.", FR: "Je ne m'y connaissais pas en retouche, mais avec ces presets, mes photos ont instantanément changé de niveau. Le guide est très clair." },
  test8Text: { PT: "Suporte nota mil e presets de extrema qualidade. Já comprei outros antes, mas nenhum se compara à fidelidade de cores da GORG. Recomendo de olhos fechados!", EN: "Excellent support and high-quality presets. I've bought others before, but none compare to GORG's color fidelity. I highly recommend them!", ES: "Excelente soporte y ajustes preestablecidos de alta calidad. He comprado outros antes, pero ninguno se compara con la fidelidad de color de GORG.", FR: "Support excellent et presets de haute qualité. J'en ai acheté d'autres, mais rien ne vaut la fidélité des couleurs GORG." },
